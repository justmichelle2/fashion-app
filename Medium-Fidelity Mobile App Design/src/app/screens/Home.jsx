      ...
      <div className="px-6 py-6 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-[#4B5563] text-xs">Designers</p>
            </div>
          </Link>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#E76F51] to-[#F4A261] rounded-3xl p-6 shadow-lg">
          <div className="flex items-center justify-between mb-5">
            <div>
              ...
              <h2 className="text-white" style={{ fontSize: "32px", fontWeight: "700" }}>3</h2>
            </div>
          ...
          <div className="grid grid-cols-3 gap-4 pt-4 border-t border-white/20">
            <div>
              ...
              <p className="text-white text-lg" style={{ fontWeight: "600" }}>12</p>
            </div>
            <div>
              <p className="text-white/70 text-xs mb-1">Designers</p>
              <p className="text-white text-lg" style={{ fontWeight: "600" }}>5</p>
            </div>
            <div>
              <p className="text-white/70 text-xs mb-1">Spent</p>
              <p className="text-white text-lg" style={{ fontWeight: "600" }}>GH₵2.5K</p>
            </div>
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-[#2D2D2D]" style={{ fontSize: "20px", fontWeight: "700" }}>
              Featured Designers
            </h2>
            <Link to="/designers" className="text-[#E76F51] text-sm flex items-center gap-1" style={{ fontWeight: "600" }}>
              View All
            ...
            {featuredDesigners.map((designer) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  />
                  <div className="flex-1">
                    <h3 className="text-[#2D2D2D] mb-1" style={{ fontSize: "16px", fontWeight: "600" }}>
                      {designer.name}
                    </h3>
                    <p className="text-[#4B5563] text-sm mb-2">{designer.specialty}</p>
                    <div className="flex items-center gap-1">
                      <Star size={14} className="text-[#F4A261] fill-[#F4A261]" />
                      <span className="text-[#2D2D2D] text-sm" style={{ fontWeight: "600" }}>{designer.rating}</span>
                    </div>
                  </div>
        ...
        {/* Recent Activity */}
        <div>
          <h2 className="text-[#2D2D2D] mb-4" style={{ fontSize: "20px", fontWeight: "700" }}>
            Recent Orders
          </h2>
          <div className="space-y-3">
            {recentOrders.map((order) => (
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <span className="text-[#4B5563] text-sm">{order.id}</span>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-[#2D2D2D] mb-1" style={{ fontWeight: "600" }}>{order.item}</p>
                    <p className="text-[#4B5563] text-sm">{order.designer}</p>
                  </div>
                  <p className="text-[#2D2D2D]" style={{ fontSize: "18px", fontWeight: "700" }}>
                    GH₵{order.amount}
                  </p>
                </div>
              </Link>
