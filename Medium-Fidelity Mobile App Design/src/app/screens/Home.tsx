      ...
      <div className="px-6 py-6 space-y-4">
          ...
          <div className="space-y-3">
            {featuredDesigners.map((designer) => (
              <Link
                ...
                className="flex items-center gap-3 p-4 bg-[#FDFDFD] rounded-2xl border border-gray-50 hover:border-[#E76F51]/30 transition-all"
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[#2D2D2D] mb-0.5 truncate" style={{ fontWeight: "600" }}>
                    {designer.name}
                  </p>
          ...
          <div className="grid grid-cols-2 gap-3">
            {styleCategories.map((category) => (
              <Link
                key={category.id}
                to="/designers"
                className="p-4 bg-[#FDFDFD] rounded-2xl border border-gray-50 hover:border-[#E76F51]/30 transition-all"
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <h4 className="text-[#2D2D2D]" style={{ fontWeight: "600" }}>
                      {category.name}
                    </h4>
        ...
        <div className="bg-gradient-to-br from-[#E76F51] to-[#F4A261] rounded-3xl p-6 text-white">
          ...
          <p className="text-white/90 text-sm mb-4">
            Upload your measurements now to get faster quotes from designers!
          </p>
          <Link
            to="/measurements"
            className="inline-block px-6 py-2.5 bg-white text-[#E76F51] rounded-xl hover:bg-white/90 transition-all"
            style={{ fontWeight: "600" }}
          >
            Upload Measurements
          </Link>
